...
namespace Epic
{
    ...
    *              GASDF3 to GASDF30810 to prevent build errors
    */
    public class GASDF30810
    {
        public GASDF30810()
        {
            ...
            //DGFN2O=DGFN2O+GFN2O Commneted out in the source file (Brian Dye)
            double SM2 = 0.0;
